...
import { penitentsAndPilgrimsUnits } from '../../data/adeptaSororitas'

export default function PenitentsAndPilgrims() {
  const [initialOptions1, initialOptions2] = penitentsAndPilgrimsUnits
