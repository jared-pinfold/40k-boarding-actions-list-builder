...
import { tyranidattackUnits } from '../../data/tyranids'

export default function TyranidAttack() {
  const [initialOptions1, initialOptions2, initialOptions3] = tyranidattackUnits
