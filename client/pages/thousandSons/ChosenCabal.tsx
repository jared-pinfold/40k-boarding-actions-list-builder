...
import { chosenCabalUnits } from '../../data/thousandSons'

export default function ChosenCabal() {
  const [initialOptions1, initialOptions2, initialOptions3] = chosenCabalUnits
    ...
    <div className="container">
      ...
      <div className="column options">
        ...
        <p>
          ...
          <strong>Rubric Marines</strong> units.
        </p>
        <ul>
          {options2.map((option) => {
