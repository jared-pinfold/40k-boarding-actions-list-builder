...
import { canoptekHarvestersUnits } from '../../data/necrons'

export default function CanoptekHarvesters() {
  const [initialOptions1, initialOptions2] = canoptekHarvestersUnits
