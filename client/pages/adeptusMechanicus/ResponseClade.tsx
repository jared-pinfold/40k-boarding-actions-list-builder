...
import { responseCladeUnits } from '../../data/adeptusMechanicus'

export default function ResponseClade() {
  const [initialOptions1, initialOptions2, initialOptions3] = responseCladeUnits
