...
import { archContaminatorsUnits } from '../../data/deathGuard'

export default function ArchContaminators() {
  const [initialOptions1, initialOptions2] = archContaminatorsUnits
