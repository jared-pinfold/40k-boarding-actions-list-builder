...
import { painbringersUnits } from '../../data/drukhari'

export default function Painbringers() {
  const [initialOptions1, initialOptions2, initialOptions3] = painbringersUnits
