...
const units = {
  ...
  autarchWayleaper: { name: 'Autarch Wayleaper', points: [115], models: [1] },
  baharroth: { name: 'Baharroth', points: [125], models: [1] },
  deathJester: { name: 'Death Jester', points: [90], models: [1] },
  direAvengers: { name: 'Dire Avengers', points: [70, 140], models: [5, 10] },
  eldradUlthuran: { name: 'Eldrad Ulthran', points: [110], models: [1] },
  farseer: { name: 'Farseer', points: [80], models: [1] },
  fireDragons: { name: 'Fire Dragons', points: [90, 180], models: [5, 10] },
  fuegan: { name: 'Fuegan', points: [130], models: [1] },
  guardianDefenders: { name: 'Guardian Defenders', points: [100], models: [11] },
  howlingBanshees: { name: 'Howling Banshees', points: [70, 140], models: [5, 10] },
  jainZar: { name: 'Jain Zar', points: [90], models: [1] },
  karandras: { name: 'Karandras', points: [90], models: [1] },
  mauganRa: { name: 'Maugan Ra', points: [115], models: [1] },
  ...
  strikingScorpions: { name: 'Striking Scorpions', points: [65, 130], models: [5, 10] },
  swoopingHawks: { name: 'Swooping Hawks', points: [85, 170], models: [5, 10] },
  troupe: { name: 'Troupe', points: [75, 90, 165], models: [5, 6, 11] },
  troupeMaster: { name: 'Troupe Master', points: [55], models: [1] },
  warlock: { name: 'Warlock', points: [45], models: [1] },
  warlockConclave: { name: 'Warlock Conclave', points: [55, 110], models: [2, 4] },
  warpSpiders: { name: 'Warp Spiders', points: [125], models: [5] },
  wraithblades: { name: 'Wraithblades', points: [160, 340], models: [5, 10] },
  wraithguard: { name: 'Wraithguard', points: [180, 380], models: [5, 10] },
}
