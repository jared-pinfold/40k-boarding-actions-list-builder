...
const units = {
  ...
  canoptekWraiths: { name: 'Canoptek Wraiths', points: [115], models: [3] },
  ...
  hexmarkDestroyer: { name: 'Hexmark Destroyer', points: [75], models: [1] },
  illuminorSzeras: { name: 'Illuminor Szeras', points: [175], models: [1] },
  immortals: { name: 'Immortals', points: [70, 150], models: [5, 10] },
  imotekhTheStormlord: {
  ...
  necronWarriors: { name: 'Necron Warriors', points: [90], models: [10] },
  ophydianDestroyers: {
  ...
  plasmancer: { name: 'Plasmancer', points: [60], models: [1] },
  psychomancer: { name: 'Psychomancer', points: [55], models: [1] },
  royalWarden: { name: 'Royal Warden', points: [50], models: [1] },
  skorpekhDestroyers: {
