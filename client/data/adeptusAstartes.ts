...
const units: Record<string, UnitData> = {
  ...
  bladeguardVeteranSquad: { name: 'Bladeguard Veteran Squad', points: [90], models: [3] }, //
  bloodAngelsCaptain: {
  ...
  companyHeroes: { name: 'Company Heroes', points: [95], models: [4] },
  ...
  innerCircleCompanions: { name: 'Inner Circle Companions', points: [190], models: [3] },
  intercessorSquad: { name: 'Intercessor Squad', points: [80, 160], models: [5, 10] },
  ...
  primarisCrusaderSquad: { name: 'Primaris Crusader Squad', points: [150], models: [10] },
  ...
  sanguinaryGuard: { name: 'Sanguinary Guard', points: [135, 270], models: [3, 6] },
  ...
  terminatorCaptain: { name: 'Terminator Captain', points: [125], models: [1] },
  terminatorChaplain: {
